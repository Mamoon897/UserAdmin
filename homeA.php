...
<body>
    <nav class="nav nav_top">
        <!-- <div class="logo">
            <a href="homeA.php"><img src="logm.jpg" width="200" height="60"></a>
        </div> -->
        <div class="nav_side">
           <a href="homeA.php">Home</a>
            <a href="userA.php">Admin Details</a>
    ...
    <!-- <footer>
        <div class="footer_logo">
            <a href="homeA.php"><img src="logm.jpg" width="30"></a>
