...
<body>
    <nav class="nav nav_top" style=" height: 60px;width:100% ;background-color:black; color:white; position:fixed">
        <div class="logo">
            <a href="homeE.php"><img src="logm.jpg=" alt="#" ></a>
        </div>
        <div class="nav_side">
           <a href="homeE.php" style="color: white;">Home</a>
            <a href="userE.php" style="color: white;">Employee Details</a>
            <a class="nav-link" href="#" style="color: white;">About Us</a>
            <a class="nav-link" href="loginA.php" style="color: white;">Logout</a>
            
    </div>    
    </nav>
    <!-- <div style="background-image: url('download.jpg'); "></div> -->
    <div class="slide">
    ...
    <div class="team">
        ...
        <div class="team_container">
            ...
            <p>We provide extraordinary study experiences, inspired by our legacy. Also, we just really love Computer Science Department.</p>
                <br><p>The department has the largest student intake among all the the departments of the University. There are four post graduate  and Ph.d. programmes. The department has four well-equipped computer laboratories with latest configurations, all connected to various servers running Operating Systems like MS Windows 2003, Red Hat Linux, Sun Solaris and Mac OS. Grid Computing and Cluster Computing have also been facilitated in the servers. All the faculty,class rooms and laboratories are connected to the campus-wide Intranet. </p>
            </div>
        </div>
    </div>
    ...
    <!-- <footer>
        <div class="footer_logo">
            ...
            <label for="" style="color:pink;">MIT Soft. Company</label>
        </div>
        <div class="pages">  
            <h3>Mishra IT Company</h3>
        ...
        <div class="contact">
            <h3>Contact Us</h3>
            <a href="https://api.WhatsApp.com/send?phone=+919570689236" target="_blank"><i class="fa fa-whatsapp" aria-hidden="true"></i></a>
            <a href="tel: +919570689236"><i class="fa fa-phone" aria-hidden="true"></i></a>
            <a href="mailto: nileshmishra@gmail.com"><i class="fa fa-envelope-o" aria-hidden="true"></i></a>
        </div> -->
        <!-- <hr>
        <p>Copyright &copy; 2023 Nilesh Mishra. All rights reserved.</p>
    </footer> -->
